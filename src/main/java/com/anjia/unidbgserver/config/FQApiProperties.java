...
public class FQApiProperties {
     ...
     * 设备轮换配置
     */
    private DeviceRotationConfig deviceRotation = new DeviceRotationConfig();
    ...
    @Data
    public static class DeviceRotationConfig {
        /** 是否启用设备轮换 */
        private Boolean enabled = true;
        /** 轮换阈值（每N次请求换一次设备） */
        private Long rotationThreshold = 100L;
        /** 是否自动生成额外设备配置 */
        private Boolean autoGenerateDevices = true;
    }
}